        ...
        foreach ($olt as $key => $value) {
            ...
            for ($i=0; $i <count($valueGpon) ; $i++) {
                ...
                if ($sub == 'gpo') {
                    ...
                    //$zona=$key;
                    //$status=$valueGpon[$i];
                    //$gponName=$valueGponName[$i];
                    //echo "<br>$keyGpon[$i]<br>$valueGponName[$i] => $valueGpon[$i]<br>";
                }
            }
        }
