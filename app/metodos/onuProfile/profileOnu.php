...
class profileOnu
{
    ...
    public function insertPotencia($ont)
    {
        if (empty($ont))
            return false;
        $result = $this->potencia->insertPotencia(self::$gpon, $ont);
        if (empty($result))
            return $result;
        return $result;
    }
    public function insertVlans($vlans)
    {
        ...
        $o = $this->vlan->insertVlanOnu($vlans);
        return $o;
    }
    ...
    public function getVlan($zona)
    {
        $vlans = [];
            ...
            $vl = $this->vlan->getVlansOnus(self::$gpon, $vlanS, $zona);
            $vlans = array_merge($vlans, $vl);
